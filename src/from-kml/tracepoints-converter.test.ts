    ...
    const kmlString = `<?xml version="1.0" encoding="UTF-8"?>
      <kml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/kml/2.2 ogckml22.xsd">
        <Document><name>Sample Frankfurt KML Trace</name>
          <Placemark>
            <TimeStamp><when>2013-07-15T10:24:52Z</when></TimeStamp>
            <Point><coordinates>8.64914,50.20346,0.0 </coordinates></Point>
          </Placemark>
          <Placemark> 
            <TimeStamp><when>2013-07-15T10:24:52Z</when></TimeStamp>
            <Point><coordinates>8.64861,50.20319,0.0 </coordinates></Point>
          </Placemark>
        </Document>
      </kml>`;
